...
{
    /// <inheritdoc />
    public partial class InitDBAlset : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Journals_Journalists_JournalistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_Journalists_JournalistId",
                        column: x => x.JournalistId,
                        principalTable: "Journalists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Journals_JournalistId",
                table: "Journals",
                column: "JournalistId");

            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_JournalistId",
                table: "Subscriptions",
                column: "JournalistId");
        }
